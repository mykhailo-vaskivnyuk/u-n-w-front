...
const getNavigateMap = (navigate: NavigateFunction) => {
  return {
    ...
    toSignup: (replace: boolean = false) => navigate(RoutesMap.ACCOUNT.SIGNUP, { replace }),
    toWaitNets: (replace: boolean = false) => navigate(RoutesMap.ACCOUNT.WAIT.INDEX, { replace }),
